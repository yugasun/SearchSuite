...
SearchSuite 是独立于框架的 TypeScript SDK。通过 `tavily:advanced` 这样的
Engine 选择 Provider，再使用统一的搜索接口：
...
- 根据 Engine 推断 `providerOptions` 和响应类型。
